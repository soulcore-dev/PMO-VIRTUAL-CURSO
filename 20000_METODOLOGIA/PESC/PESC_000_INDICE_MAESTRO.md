...
```yaml
20000_METODOLOGIA/PESC/
│
├── PESC_000_INDICE_MAESTRO.md        # ← ESTÁS AQUÍ
│
├── 01_NEUROCIENCIA/
...
```mermaid
graph LR
    A[PESC_001-003<br>NEUROCIENCIA] --> B[PESC_004<br>TEORÍAS]
    B --> C[PESC_005<br>DISEÑO]
    C --> D[PESC_006<br>MAYER]
    D --> E[PESC_007<br>TÉCNICAS]
    E --> F[PESC_008-009<br>POA + VMOF]
    F --> G[PESC_010<br>EVALUACIÓN]
    G --> H[PESC_011-012<br>ENGAGEMENT]
    H --> I[PESC_013-014<br>INCLUSIÓN]
    I --> J[PESC_015<br>UX]
    J --> K[PESC_016<br>TEMPLATE]
```
